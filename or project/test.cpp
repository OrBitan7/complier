...
void input_from_user(const string &massage, set<int> &identifier)
{
    cout << massage;
    string temp;
    cin >> temp;
...
void input_from_user(const string &massage, set<string> &identifier)
{
    cout << massage;
    string temp;
    cin >> temp;
...
int main()
{
    ...
    // Token: 'ID' = a
    // Token: ')'
    if ((make_literal<string>({"heaasd"})) == a)
    // Token: '{'
    // Token: 'ID' = a
    {
        // Token: 'symbol' = =
